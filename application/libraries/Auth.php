...
class Auth
{
    ...
    */
    ...
    protected function setUser()
    {
        ...
        // print_r($this->CI->session->set_userdata);exit;
        $this->error['status'] = 1;
        return $this->error;
    }

    protected function get_userName(){
    $data= $this->CI->db->get_where("user_details", array("user_id" => $this->user->logid))->row();
    // pre($this->user->logid);exit;
    return $data;
