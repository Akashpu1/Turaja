...
.swatch label{width:45px!important;height:46px!important;margin:0;border:1px solid #999999;background-color:transparent;font-size:15px!important;text-align:center;line-height:45px;overflow:hidden;white-space:nowrap;position:relative;text-transform:uppercase;cursor:pointer;padding:0;color:#999999;border-radius:50%!important}
.swatch label:hover{box-shadow:0 0 1px 1px #ccc}
.swatch-element{display:inline-block;margin:2px 15px 0 0}
.swatch-element.selected label{color:#fbfaf8;border:2px solid #a8741a; background-color:#a8741a; box-shadow: 0 0 1px 1px #ccc;font-weight: 400;
                    ...
                    <div class="sp-img_area">
                        ...
                        "asNavFor": ".sp-img_slider-nav"
                            ...
                            <div class="single-slide red zoom">
                                <img src="<?php echo base_url('uploads/product/').$product->profile_pic ?>"  alt="<?php echo $product->profile_pic ?>">
                            </div>
                        ...
                        <div class="sp-essential_stuff">
                            <ul>
                                ...
                                <?php endif; ?></li>
                                  ...
                                  <li style="font-size:25px; color:#a8741a;" id="inr">₹<?php echo number_format(($product->price - ($product->price*$product->discount/100)), 0); ?></li>
                                  <li style="font-size:25px; color:#a8741a;" id="dlr">$<?php echo number_format(($product->usd - ($product->usd*$product->discount/100)), 0); ?></li>
                            </ul>
                        </div>
...
<!-- Product Tab Area Two End Here -->
        ...
        <li class="nav-item">
        <a class="nav-link active" id="BODYSIZE" data-toggle="tab" href="#BODYSIZE" role="tab" aria-controls="BODYSIZE" aria-selected="true">BODY SIZE CHART</a>
        </li>
        <li class="nav-item">
        <a class="nav-link" id="GARMENTSIZE" data-toggle="tab" href="#GARMENTSIZE" role="tab" aria-controls="GARMENTSIZE" aria-selected="false">GARMENT SIZE CHART</a>
        </li>
        </ul>
        <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="BODYSIZE" role="tabpanel" aria-labelledby="BODYSIZE-tab">
        <div class="row">
          <div class="col-sm-6"><img src="<?php echo base_url('uploads/product/').$size->chart ?>"></div>
          <div class="col-sm-6"><img src="<?php echo base_url('uploads/product/').$size->image ?>"></div>
        </div>

        </div>
        <div class="tab-pane fade" id="GARMENTSIZE" role="tabpanel" aria-labelledby="GARMENTSIZE-tab">...</div>
        <!-- <div class="row">
          <div class="col-sm-6"><img src="<?php echo base_url('uploads/product/').$size->chart ?>"></div>
          <div class="col-sm-6"><img src="<?php echo base_url('uploads/product/').$size->image ?>"></div>
        </div> -->
