...
<head>
  ...
  <title><?php echo $settings->application_name ?> - <?php echo $settings->application_title; ?></title>
  <meta name="robots" content="noindex, follow" />
  <meta name="description" content="">
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url($settings->application_favicon); ?>" type="image/x-icon">
  ...
  <style>
    ...
    @media(min-width:991px) and (max-width:1300px) {
      .position-static .main-nav>ul>li a {
        font-size: 12px;
      }
    }
  </style>
