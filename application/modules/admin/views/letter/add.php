						...
						<div class="panel-body">
							<div class="table-wrap">
								<div class="table-responsive">
									<table id="datable_1" class="table table-hover display data-table pb-30" >
										<thead>
										   <tr>
										     <th>S.No</th>
										     <th>Email</th>
	...
	<script>
		 function delete_detail(id) {
			 ...
			 if (del == true) {
				 ...
				 if (sureDel == true) {
					 window.location = "<?php echo base_url()?>admin/newsletter/Delete/" + id;
				 }
