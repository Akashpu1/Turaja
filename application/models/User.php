...
class User extends CI_Model
{
    ...
    {
        return $this->db->get_where("customers", array("id" => $id))->num_rows();
    }
    ...
    public function address($id) {
        return $this->db->select('address_id, CONCAT(street, " ", post, " ", city, " ", state, " - ", pincode) AS addstr, address')->get_where("address", array("user_id" => $id))->result();
    }
    
    public function findaddress($id) {
        return $this->db->get_where("address", array("address_id" => $id))->row();
    }
