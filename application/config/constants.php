...
defined('ROLE_ADMIN')      OR define('ROLE_ADMIN', 'a'); // Admin role id
defined('ROLE_STUDENT')      OR define('ROLE_STUDENT', 'u'); // student role id
...
defined('USER_PRE')      OR define('USER_PRE', 'TC'); // Upload folder path
